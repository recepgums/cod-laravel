...
@section('styles')
    <style>
        ...
        .product-image-slider figure {
            width: 100%;
            height: auto;
            min-height: 400px; /* Belirli bir yükseklik tanımlanabilir */
            background-color: #f0f0f0; /* Geçici bir arka plan rengi eklenebilir */
        }
                        ...
                        <div class="product-detail accordion-detail">
                            <div class="row mb-10">
                                    ...
                                    <div class="detail-gallery">
                                        <div class="product-image-slider">
                                            <figure class="border-radius-10">
                                                <img src="{{asset('assets/imgs/products/uzay-bulut-robotu/10.webp')}}" width="600" height="400" loading="lazy"  alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="{{asset('assets/imgs/products/uzay-bulut-robotu/13.webp')}}" width="600" height="400" loading="lazy" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img alt="" src="{{asset('assets/imgs/products/uzay-bulut-robotu/kurulum.webp')}}" width="600" height="400" loading="lazy">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="{{asset('assets/imgs/products/uzay-bulut-robotu/15.webp')}}" width="600" height="400" loading="lazy" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="{{asset('assets/imgs/products/uzay-bulut-robotu/16.webp')}}" width="600" height="400" loading="lazy" alt="product image">
                                            </figure>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-lg-12 mt-20 m-auto entry-main-content">
                                        ...
                                        <div class="row">
                                            <div class="col-6 comment-item">
                                                <div class="comment-card">
                                                    <img src="{{asset('assets/imgs/products/uzay-bulut-robotu/reviews/1.webp')}}" width="600" height="400" loading="lazy" class="img-fluid comment-img" alt="Comment Image">
                                            ...
                                            <div class="col-6 comment-item">
                                                <div class="comment-card">
                                                    <img src="{{asset('assets/imgs/products/uzay-bulut-robotu/reviews/2.webp')}}" width="600" height="400" loading="lazy" class="img-fluid comment-img" alt="Comment Image">
                                                    <div class="comment-content">
                                                        <div class="product-rate d-inline-block mb-1">
                                                            <div class="product-rating" style="width:90%">
                                                            </div>
                                            ...
                                            <div class="col-6 comment-item">
                                                <div class="comment-card">
                                                    <img src="{{asset('assets/imgs/products/uzay-bulut-robotu/reviews/3.webp')}}" width="600" height="400" loading="lazy" class="img-fluid comment-img" alt="Comment Image">
                                                    <div class="comment-content">
                                                        <div class="product-rate d-inline-block mb-1">
                                                            <div class="product-rating" style="width:90%">
                                                            </div>
                                            ...
                                            <div class="col-6 comment-item">
                                                <div class="comment-card">
                                                    <img src="{{asset('assets/imgs/products/uzay-bulut-robotu/reviews/4.webp')}}" width="600" height="400" loading="lazy" class="img-fluid comment-img" alt="Comment Image">
                                                    <div class="comment-content">
                                                        <div class="product-rate d-inline-block mb-1">
                                                            <div class="product-rating" style="width:90%">
                                                            </div>
                                            ...
                                            <div class="col-6 comment-item">
                                                <div class="comment-card">
                                                    <img src="{{asset('assets/imgs/products/uzay-bulut-robotu/reviews/5.webp')}}" width="600" height="400" loading="lazy" class="img-fluid comment-img" alt="Comment Image">
                                                    <div class="comment-content">
                                                        <div class="product-rate d-inline-block mb-1">
                                                            <div class="product-rating" style="width:90%">
                                                            </div>
                                            ...
                                            <div class="col-6 comment-item">
                                                <div class="comment-card">
                                                    <img src="{{asset('assets/imgs/products/uzay-bulut-robotu/reviews/6.webp')}}" width="600" height="400" loading="lazy" class="img-fluid comment-img" alt="Comment Image">
                                                    <div class="comment-content">
                                                        <div class="product-rate d-inline-block mb-1">
                                                            <div class="product-rating" style="width:90%">
                                                            </div>
                                            ...
                                            <div class="col-6 comment-item">
                                                <div class="comment-card">
                                                    <img src="{{asset('assets/imgs/products/uzay-bulut-robotu/reviews/7.webp')}}" width="600" height="400" loading="lazy" class="img-fluid comment-img" alt="Comment Image">
                                                    <div class="comment-content">
                                                        <div class="product-rate d-inline-block mb-1">
                                                            <div class="product-rating" style="width:90%">
                                                            </div>
                                            ...
                                            <div class="col-6 comment-item">
                                                <div class="comment-card">
                                                    <img src="{{asset('assets/imgs/products/uzay-bulut-robotu/reviews/8.webp')}}" width="600" height="400" loading="lazy" class="img-fluid comment-img" alt="Comment Image">
                                                    <div class="comment-content">
                                                        <div class="product-rate d-inline-block mb-1">
                                                            <div class="product-rating" style="width:90%">
                                                            </div>
                                            ...
                                            <div class="col-6 comment-item">
                                                <div class="comment-card">
                                                    <img src="{{asset('assets/imgs/products/uzay-bulut-robotu/reviews/9.webp')}}" width="600" height="400" loading="lazy" class="img-fluid comment-img" alt="Comment Image">
                                                    <div class="comment-content">
                                                        <div class="product-rate d-inline-block mb-1">
                                                            <div class="product-rating" style="width:90%">
                                                            </div>
                                            ...
                                            <div class="col-6 comment-item">
                                                <div class="comment-card">
                                                    <img src="{{asset('assets/imgs/products/uzay-bulut-robotu/reviews/10.webp')}}" width="600" height="400" loading="lazy" class="img-fluid comment-img" alt="Comment Image">
                                                    <div class="comment-content">
                                                        <div class="product-rate d-inline-block mb-1">
                                                            <div class="product-rating" style="width:90%">
                                                            </div>
                                                ...
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img">
                                                        <a href="shop-product-right.html" tabindex="0">
                                                            <img class="default-img" loading="lazy" width="600" height="400" src="{{asset('assets/imgs/products/trendsand-kum-sanati/yenifistarl4.webp')}}" alt="">
                                                            <img class="hover-img" loading="lazy" width="600" height="400" src="{{asset('assets/imgs/products/trendsand-kum-sanati/short.gif')}}" alt="">
                                                        </a>
                                                    </div>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap small hover-up">
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img">
                                                        <a href="shop-product-right.html" tabindex="0">
                                                            <img class="default-img" loading="lazy" width="600" height="400" src="{{asset('assets/imgs/products/cosmos-yildiz-yagmuru/1.webp')}}" alt="">
                                                            <img class="hover-img" loading="lazy" width="600" height="400" src="{{asset('assets/imgs/products/cosmos-yildiz-yagmuru/1.webp')}}" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="product-badges product-badges-position product-badges-mrg">
